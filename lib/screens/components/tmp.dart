...
class MultiSelectTableComponent
  ...
  Widget buildTable(WebappTable table, BuildContext context) {
    ...
    Map<int, TableColumnWidth> colWidths = infoBoxBuilder == null ? const {0: FixedColumnWidth(50),1:const FixedColumnWidth(10)} :  {0: const FixedColumnWidth(50),1:const FixedColumnWidth(50) };

...
class AppTextStyles {
  ...
  // Page title
  static const TextStyle pageTitle = TextStyle(fontSize: 32, fontWeight: FontWeight.w700, height: 1.25);
  ...
  // Subheading
  static const TextStyle subheading = TextStyle(fontSize: 18, fontWeight: FontWeight.w400, height: 1.5);
  ...
  // Caption / metadata
  static const TextStyle caption = TextStyle(fontSize: 11, fontWeight: FontWeight.w400, height: 1.5);
